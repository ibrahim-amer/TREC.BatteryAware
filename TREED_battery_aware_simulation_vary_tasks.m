function [result] = TREED_battery_aware_simulation_vary_tasks(M_min, M_max, M_stepSize, number_of_simulations, checkConstraints)
%%
arguments
    M_min (1, 1) double = 2
    M_max (1, 1) double = 20
    ...
    signature = strcat('[scenario2 - vary_tasks][N_min =  ', int2str(N_min), ', ', ...
        ' N_max =  ', int2str(N_max), ', ', ...
