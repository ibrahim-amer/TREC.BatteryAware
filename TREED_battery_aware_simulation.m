function [allResults] = TREED_battery_aware_simulation(N_min, N_max, N_stepSize, M_min, M_max, M_stepSize, number_of_simulations, dataObj, checkConstraints)
%%
arguments
    N_min (1, 1) double = 2
    ...
    for N = N_min:N_stepSize:N_max
        ...
        for M = M_min:M_stepSize:M_max
            ...
            temp_dataObj = TREED_battery_aware_slice_data(N, M, dataObj);
